...
`ospd.process-profiles.kindgrove-steps.parse-aoi-steps` *v0.1*
...
The CWL CommandLineTool is referenced, not copied: <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#parse_aoi>.
...
```json
{
  "id": "parse_aoi",
  "version": "0.1.0",
  "title": "Parse area of interest",
  "description": "Splits an OGC bounding box into its west, south, east and north coordinates.",
  "mutable": true,
  "keywords": [
    "ospd",
    "mangrove",
  ...
  "metadata": [
    {
      ...
      "value": "Parse area of interest"
    },
    {
      "role": "https://schema.org/description",
      "value": "Splits an OGC bounding box into its west, south, east and north coordinates."
    },
    {
...
```jsonld
{
  "@context": "https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/parse-aoi-steps/context.jsonld",
  "id": "parse_aoi",
  "version": "0.1.0",
  "title": "Parse area of interest",
  "description": "Splits an OGC bounding box into its west, south, east and north coordinates.",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> dcterms:description "Splits an OGC bounding box into its west, south, east and north coordinates." ;
    dcterms:subject "biomass",
        ...
        "sentinel-2",
        "stac" ;
    dcterms:title "Parse area of interest" ;
    pp:version "0.1.0" ;
    proc:inputs [ ns3:aoi [ dcterms:description "Area of interest defined as a bounding box" ;
    ...
    proc:metadata [ rdf:value "https://github.com/starling-foundries/KindGrove" ;
        ...
        [ rdf:value "Splits an OGC bounding box into its west, south, east and north coordinates." ;
        ...
        [ rdf:value "Parse area of interest" ;
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#parse_aoi",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> pp:version "0.1.0" .
...
[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#parse_aoi" ;
...
[
  {
    ...
    "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/parse-aoi-steps",
    "startedAtTime": "2026-09-24T10:57:45Z",
    "used": [
      "urn:example:entity:parse-aoi-steps:in:aoi"
    ],
    "wasAssociatedWith": [
    ...
    "endedAtTime": "2026-09-24T10:57:48Z"
  },
  {
    "id": "urn:example:entity:parse-aoi-steps:in:aoi",
  ...
  {
    "id": "urn:example:entity:parse-aoi-steps:out:east",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/east",
    "wasGeneratedBy": "urn:example:run:kindgrove-steps:parse-aoi-steps",
    "value": 95.35,
    "wasAttributedTo": "urn:example:engine:cwltool-3.1.20260108082145"
  },
  {
    "id": "urn:example:entity:parse-aoi-steps:out:north",
    "provType": "prov:Entity",
  ...
  {
    "id": "urn:example:entity:parse-aoi-steps:out:south",
    "provType": "prov:Entity",
  ...
  {
    "id": "urn:example:entity:parse-aoi-steps:out:west",
    "provType": "prov:Entity",
...
<urn:example:entity:parse-aoi-steps:out:east> a prov:Entity,
    ...
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:parse-aoi-steps> .

<urn:example:entity:parse-aoi-steps:out:north> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/north> ;
    rdf:value 1.61e+01 ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:parse-aoi-steps> .

<urn:example:entity:parse-aoi-steps:out:south> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/south> ;
    rdf:value 1.59e+01 ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:parse-aoi-steps> .

<urn:example:entity:parse-aoi-steps:out:west> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/west> ;
    rdf:value 9.515e+01 ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:parse-aoi-steps> .

<urn:example:entity:parse-aoi-steps:in:aoi> a prov:Entity,
...
<urn:example:run:kindgrove-steps:parse-aoi-steps> a prov:Activity,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/parse-aoi-steps> ;
    prov:endedAtTime "2026-09-24T10:57:48+00:00"^^xsd:dateTime ;
    ...
    prov:startedAtTime "2026-09-24T10:57:45+00:00"^^xsd:dateTime ;
    prov:used <urn:example:entity:parse-aoi-steps:in:aoi> ;
...
<urn:example:run:kindgrove-steps:parse-aoi-steps> a wfprov:ProcessRun,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/parse-aoi-steps> ;
    wfprov:describedByProcess <https://ospd.example.org/ogc-api/processes/parse_aoi> ;
    wfprov:usedInput <urn:example:entity:parse-aoi-steps:in:aoi> ;
...
```json
{
  "id": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/parse-aoi-steps",
  "type": "ProcessType",
  ...
  "profile": "ospd.process-profiles.kindgrove-steps.parse-aoi-steps",
  "processDescription": {
    "id": "parse_aoi",
    "version": "0.1.0"
  },
  "source": {
    "cwl": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#parse_aoi",
  ...
  "openeoEquivalence": {
    "level": "none",
    "rationale": "Structural helper: unpacks an OGC BBox record into west/south/east/north floats -- no `output_dir` (unlike `kindgrove.parse-aoi`, which this profile parallels but does not replace). No openEO process does this, since openEO passes a bounding box directly."
  }
}
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/parse-aoi-steps> a skos:Concept ;
    skos:broader <https://geolabs.github.io/bblocks-process-profiles/def/phase/filter-configuration> ;
    skos:definition "Splits an OGC bounding box into its west, south, east and north coordinates." ;
    ...
    pp:openeoEquivalence [ pp:equivalenceLevel "none" ;
            pp:rationale "Structural helper: unpacks an OGC BBox record into west/south/east/north floats -- no `output_dir` (unlike `kindgrove.parse-aoi`, which this profile parallels but does not replace). No openEO process does this, since openEO passes a bounding box directly." ] ;
    pp:processDescription <https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> ;
    pp:profile "ospd.process-profiles.kindgrove-steps.parse-aoi-steps" ;
    pp:provenanceClass wfprov:ProcessRun ;
    pp:source [ pp:cwl <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#parse_aoi> ;
...
* YAML version: [schema.yaml](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/parse-aoi-steps/schema.json)
* JSON version: [schema.json](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/parse-aoi-steps/schema.yaml)
...
[context.jsonld](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/parse-aoi-steps/context.jsonld)
...
* Path: `_sources/kindgrove-steps/parse-aoi-steps`
