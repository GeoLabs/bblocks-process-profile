...
# Process profile: export_stac (Schema)

`ospd.process-profiles.kindgrove-steps.export-stac` *v0.1*
...
The CWL CommandLineTool is referenced, not copied: <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#export_stac>.
...
```json
{
  ...
  "metadata": [
    ...
    },
    {
      ...
      "value": "Plot the biomass map and export the results as a STAC Catalog"
    }
  ],
  "inputs": {
    "mangrove_mask_file": {
...
```jsonld
{
  "@context": "https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/export-stac/context.jsonld",
  "id": "export_stac",
  "version": "0.1.0",
  "title": "export_stac",
  "description": "Process converted from CWL",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/export_stac> dcterms:description "Process converted from CWL" ;
    dcterms:subject "export",
        "mangrove",
        "ospd",
        "stac" ;
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#export_stac",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/export_stac> pp:version "0.1.0" .

[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/export_stac> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#export_stac" ;
...
```json
{
  "inputs": {
    "mangrove_mask_file": {
      "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/mangrove_mask.tif",
      "type": "image/tiff; application=geotiff"
    },
    "biomass_file": {
      "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/biomass.tif",
      "type": "image/tiff; application=geotiff"
    },
    "biomass_summary_file": {
      "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/biomass_summary.csv",
      "type": "text/csv"
    },
    "carbon_summary_file": {
      "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/carbon_summary.csv",
      "type": "text/csv"
    },
    "analysis_summary_file": {
      "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/analysis_summary.json",
...
[] proc:inputs [ ns1:analysis_summary_file [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/analysis_summary.json" ;
                    proc:type "application/json" ] ;
            ns1:biomass_file [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/biomass.tif" ;
                    proc:type "image/tiff; application=geotiff" ] ;
            ns1:biomass_summary_file [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/biomass_summary.csv" ;
                    proc:type "text/csv" ] ;
            ns1:carbon_summary_file [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/carbon_summary.csv" ;
                    proc:type "text/csv" ] ;
            ns1:east 9.535e+01 ;
            ns1:mangrove_mask_file [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/mangrove_mask.tif" ;
                    proc:type "image/tiff; application=geotiff" ] ;
            ns1:north 1.61e+01 ;
            ns1:south 1.59e+01 ;
...
{
  "stac_catalog": {
    "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-export-stac-0001/results/catalog.json",
    "type": "application/json"
  }
}
...
[] pp:stac_catalog [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/json> ;
            pp:href "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-export-stac-0001/results/catalog.json" ] .
...
[
  {
    ...
    "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/export-stac",
    "startedAtTime": "2026-09-24T10:59:47Z",
    "used": [
      "urn:example:entity:export-stac:in:mangrove_mask_file",
      "urn:example:entity:export-stac:in:biomass_file",
      "urn:example:entity:export-stac:in:biomass_summary_file",
      "urn:example:entity:export-stac:in:carbon_summary_file",
      "urn:example:entity:export-stac:in:analysis_summary_file",
      "urn:example:entity:export-stac:in:stac_item",
      "urn:example:entity:export-stac:in:west",
      "urn:example:entity:export-stac:in:south",
      "urn:example:entity:export-stac:in:east",
      "urn:example:entity:export-stac:in:north"
    ],
    "wasAssociatedWith": [
      "urn:example:engine:cwltool-3.1.20260108082145",
      "urn:example:image:ghcr.io/geolabs/kindgrove/export-stac:v0.0.2-rc2"
    ],
    "qualifiedAssociation": [
      {
        "agent": "urn:example:engine:cwltool-3.1.20260108082145",
        "hadPlan": "https://ospd.example.org/ogc-api/processes/export_stac"
      }
    ],
    "endedAtTime": "2026-09-24T10:59:58Z"
  },
  {
    "id": "urn:example:entity:export-stac:in:mangrove_mask_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/mangrove_mask_file",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/mangrove_mask.tif",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:export-stac:in:biomass_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/biomass_file",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/biomass.tif",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:export-stac:in:biomass_summary_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/biomass_summary_file",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/biomass_summary.csv",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:export-stac:in:carbon_summary_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/carbon_summary_file",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/carbon_summary.csv",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:export-stac:in:analysis_summary_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/analysis_summary_file",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/analysis_summary.json",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:export-stac:in:stac_item",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/stac_item",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/scene_item.json",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:export-stac:in:west",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/west",
    "value": 95.15
  },
  {
    "id": "urn:example:entity:export-stac:in:south",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/south",
    "value": 15.9
  },
  {
    "id": "urn:example:entity:export-stac:in:east",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/east",
    "value": 95.35
  },
  {
    "id": "urn:example:entity:export-stac:in:north",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#inputs/north",
    "value": 16.1
  },
  {
    "id": "urn:example:entity:export-stac:out:stac_catalog",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/export_stac#outputs/stac_catalog",
    "wasGeneratedBy": "urn:example:run:kindgrove-steps:export-stac",
    "wasDerivedFrom": [
      "urn:example:entity:export-stac:in:mangrove_mask_file",
      "urn:example:entity:export-stac:in:biomass_file",
      "urn:example:entity:export-stac:in:biomass_summary_file",
  ...
  {
    "id": "urn:example:image:ghcr.io/geolabs/kindgrove/export-stac:v0.0.2-rc2",
    "provType": "prov:SoftwareAgent",
    "name": "container image ghcr.io/geolabs/kindgrove/export-stac:v0.0.2-rc2"
  }
]
...
<urn:example:entity:export-stac:out:stac_catalog> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#outputs/stac_catalog> ;
    rdfs:seeAlso [ dcterms:type "application/json" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/kindgrove-steps-export-stac-0001/results/catalog.json> ] ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasDerivedFrom <urn:example:entity:export-stac:in:analysis_summary_file>,
        <urn:example:entity:export-stac:in:biomass_file>,
        <urn:example:entity:export-stac:in:biomass_summary_file>,
        <urn:example:entity:export-stac:in:carbon_summary_file>,
        <urn:example:entity:export-stac:in:mangrove_mask_file>,
        <urn:example:entity:export-stac:in:stac_item> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:export-stac> .

<urn:example:entity:export-stac:in:east> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/east> ;
    rdf:value 9.535e+01 .

<urn:example:entity:export-stac:in:north> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/north> ;
    rdf:value 1.61e+01 .

<urn:example:entity:export-stac:in:south> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/south> ;
    rdf:value 1.59e+01 .

<urn:example:entity:export-stac:in:west> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/west> ;
    rdf:value 9.515e+01 .

<urn:example:image:ghcr.io/geolabs/kindgrove/export-stac:v0.0.2-rc2> a prov:SoftwareAgent ;
    pp:name "container image ghcr.io/geolabs/kindgrove/export-stac:v0.0.2-rc2" .

<urn:example:run:kindgrove-steps:export-stac> a prov:Activity,
    ...
    prov:qualifiedAssociation [ prov:agent <urn:example:engine:cwltool-3.1.20260108082145> ;
            prov:hadPlan <https://ospd.example.org/ogc-api/processes/export_stac> ] ;
    prov:startedAtTime "2026-09-24T10:59:47+00:00"^^xsd:dateTime ;
    prov:used <urn:example:entity:export-stac:in:analysis_summary_file>,
        <urn:example:entity:export-stac:in:biomass_file>,
        <urn:example:entity:export-stac:in:biomass_summary_file>,
        <urn:example:entity:export-stac:in:carbon_summary_file>,
        <urn:example:entity:export-stac:in:east>,
...
<urn:example:entity:export-stac:in:analysis_summary_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/analysis_summary_file> ;
    rdfs:seeAlso [ dcterms:type "application/json" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/upstream-step/results/analysis_summary.json> ] .

<urn:example:entity:export-stac:in:biomass_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/biomass_file> ;
    rdfs:seeAlso [ dcterms:type "image/tiff; application=geotiff" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/upstream-step/results/biomass.tif> ] .

<urn:example:entity:export-stac:in:biomass_summary_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/biomass_summary_file> ;
    rdfs:seeAlso [ dcterms:type "text/csv" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/upstream-step/results/biomass_summary.csv> ] .

<urn:example:entity:export-stac:in:carbon_summary_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/carbon_summary_file> ;
    rdfs:seeAlso [ dcterms:type "text/csv" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/upstream-step/results/carbon_summary.csv> ] .

<urn:example:entity:export-stac:in:mangrove_mask_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/mangrove_mask_file> ;
    rdfs:seeAlso [ dcterms:type "image/tiff; application=geotiff" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/upstream-step/results/mangrove_mask.tif> ] .

<urn:example:entity:export-stac:in:stac_item> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/export_stac#inputs/stac_item> ;
...
```json
{
  ...
  "type": "ProcessRun",
  "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/export-stac",
  "describedByProcess": "https://ospd.example.org/ogc-api/processes/export_stac",
  "usedInput": [
    {
      "id": "urn:example:entity:export-stac:in:mangrove_mask_file"
    },
...
<urn:example:run:kindgrove-steps:export-stac> a wfprov:ProcessRun,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/export-stac> ;
    wfprov:describedByProcess <https://ospd.example.org/ogc-api/processes/export_stac> ;
    wfprov:usedInput <urn:example:entity:export-stac:in:analysis_summary_file>,
        <urn:example:entity:export-stac:in:biomass_file>,
        <urn:example:entity:export-stac:in:biomass_summary_file>,
        <urn:example:entity:export-stac:in:carbon_summary_file>,
        <urn:example:entity:export-stac:in:east>,
...
```json
{
  "id": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/export-stac",
  "type": "ProcessType",
  "prefLabel": "Plot the biomass map and export a STAC catalog",
  ...
  "profile": "ospd.process-profiles.kindgrove-steps.export-stac",
  "processDescription": {
    "id": "export_stac",
    "version": "0.1.0"
  },
  "source": {
    "cwl": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#export_stac",
  ...
  "openeoEquivalence": {
    "level": "closeMatch",
    "rationale": "Writes the final rasters and summaries to a self-describing STAC output, plus a quicklook PNG rendering; save_result's STAC output option is the closest openEO equivalent, same partial match as `algae-bloom.plot-image` and `water-bodies.stac`."
  }
}
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/export-stac> a skos:Concept ;
    ...
    skos:definition "Plots the biomass map and exports the mangrove analysis results as a STAC Catalog." ;
    skos:inScheme pp:process-type ;
    skos:prefLabel "Plot the biomass map and export a STAC catalog" ;
    pp:candidateCctDependency "eoap.cct.stac" ;
    pp:openeoEquivalence [ pp:equivalenceLevel "closeMatch" ;
            pp:rationale "Writes the final rasters and summaries to a self-describing STAC output, plus a quicklook PNG rendering; save_result's STAC output option is the closest openEO equivalent, same partial match as `algae-bloom.plot-image` and `water-bodies.stac`." ] ;
    pp:processDescription <https://geolabs.github.io/bblocks-process-profiles/def/process/export_stac> ;
    pp:profile "ospd.process-profiles.kindgrove-steps.export-stac" ;
    pp:provenanceClass wfprov:ProcessRun ;
    pp:source [ pp:cwl <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#export_stac> ;
            pp:cwlClass "CommandLineTool" ;
            pp:cwlId "export_stac" ;
...
description: Profile of the OGC API - Processes processDescription of `export_stac`
...
* YAML version: [schema.yaml](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/export-stac/schema.json)
* JSON version: [schema.json](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/export-stac/schema.yaml)
...
[context.jsonld](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/export-stac/context.jsonld)
...
* Path: `_sources/kindgrove-steps/export-stac`
