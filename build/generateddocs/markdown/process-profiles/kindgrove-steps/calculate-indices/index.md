...
# Process profile: calculate_indices (Schema)

`ospd.process-profiles.kindgrove-steps.calculate-indices` *v0.1*
...
The CWL CommandLineTool is referenced, not copied: <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#calculate_indices>.
...
```json
{
  ...
  "metadata": [
    ...
    },
    {
      ...
      "value": "Compute NDVI, NDWI and SAVI from Sentinel-2 red, green and NIR bands"
    }
  ],
  "inputs": {
    "band_files": {
...
```jsonld
{
  "@context": "https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/calculate-indices/context.jsonld",
  "id": "calculate_indices",
  "version": "0.1.0",
  "title": "calculate_indices",
  "description": "Process converted from CWL",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/calculate_indices> dcterms:description "Process converted from CWL" ;
    dcterms:subject "mangrove",
        "ndvi",
        "ndwi",
        "ospd",
        "savi" ;
    dcterms:title "calculate_indices" ;
    pp:version "0.1.0" ;
    proc:inputs [ ns3:band_files [ dcterms:description "" ;
                    dcterms:title "band_files" ;
                    proc:maxOccurs 1 ;
                    proc:minOccurs 1 ;
    ...
    proc:metadata [ rdf:value "https://spdx.org/licenses/CC-BY-NC-SA-4.0" ;
        ...
        [ rdf:value "Compute NDVI, NDWI and SAVI from Sentinel-2 red, green and NIR bands" ;
        ...
        [ rdf:value "calculate_indices" ;
            proc:role schema:name ] ;
    proc:mutable true ;
    proc:outputTransmission "reference",
        "value" ;
    proc:outputs [ ns2:ndvi_file [ dcterms:description "" ;
                    dcterms:title "ndvi_file" ;
                    proc:schema [ proc:type "string" ;
                            ns1:contentMediaType "application/octet-stream" ] ] ;
            ns2:ndwi_file [ dcterms:description "" ;
                    dcterms:title "ndwi_file" ;
                    proc:schema [ proc:type "string" ;
                            ns1:contentMediaType "application/octet-stream" ] ] ;
            ns2:savi_file [ dcterms:description "" ;
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#calculate_indices",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/calculate_indices> pp:version "0.1.0" .

[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/calculate_indices> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#calculate_indices" ;
...
```json
{
  "inputs": {
    "band_files": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/red_4326.tif",
        "type": "geotiff"
      },
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/green_4326.tif",
        "type": "geotiff"
      },
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/nir_4326.tif",
        "type": "geotiff"
      }
    ]
  },
...
[] proc:inputs [ ns1:band_files [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/nir_4326.tif" ;
                    proc:type "geotiff" ],
                [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/green_4326.tif" ;
                    proc:type "geotiff" ],
                [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/red_4326.tif" ;
                    proc:type "geotiff" ] ] ;
...
{
  "ndvi_file": {
    "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/ndvi.tif",
    "type": "image/tiff; application=geotiff"
  },
  "ndwi_file": {
    "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/ndwi.tif",
    "type": "image/tiff; application=geotiff"
  },
  "savi_file": {
    "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/savi.tif",
    "type": "image/tiff; application=geotiff"
  }
}
...
[] pp:ndvi_file [ pp:href "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/ndvi.tif" ] ;
    pp:ndwi_file [ pp:href "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/ndwi.tif" ] ;
    pp:savi_file [ pp:href "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/savi.tif" ] .
...
[
  {
    ...
    "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/calculate-indices",
    "startedAtTime": "2026-09-24T10:59:32Z",
    "used": [
      "urn:example:entity:calculate-indices:in:band_files"
    ],
    "wasAssociatedWith": [
      "urn:example:engine:cwltool-3.1.20260108082145",
      "urn:example:image:ghcr.io/geolabs/kindgrove/calculate-indices:v0.0.2-rc2"
    ],
    "qualifiedAssociation": [
      {
        "agent": "urn:example:engine:cwltool-3.1.20260108082145",
        "hadPlan": "https://ospd.example.org/ogc-api/processes/calculate_indices"
      }
    ],
    "endedAtTime": "2026-09-24T10:59:40Z"
  },
  {
    "id": "urn:example:entity:calculate-indices:in:band_files",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/calculate_indices#inputs/band_files",
    "value": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/red_4326.tif",
        "type": "geotiff"
  ...
  {
    "id": "urn:example:entity:calculate-indices:out:ndvi_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/calculate_indices#outputs/ndvi_file",
    "wasGeneratedBy": "urn:example:run:kindgrove-steps:calculate-indices",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/ndvi.tif",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:calculate-indices:out:ndwi_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/calculate_indices#outputs/ndwi_file",
    "wasGeneratedBy": "urn:example:run:kindgrove-steps:calculate-indices",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/ndwi.tif",
  ...
  {
    "id": "urn:example:entity:calculate-indices:out:savi_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/calculate_indices#outputs/savi_file",
    "wasGeneratedBy": "urn:example:run:kindgrove-steps:calculate-indices",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/savi.tif",
  ...
  {
    "id": "urn:example:image:ghcr.io/geolabs/kindgrove/calculate-indices:v0.0.2-rc2",
    "provType": "prov:SoftwareAgent",
    "name": "container image ghcr.io/geolabs/kindgrove/calculate-indices:v0.0.2-rc2"
  }
]
...
<urn:example:entity:calculate-indices:out:ndvi_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/calculate_indices#outputs/ndvi_file> ;
    rdfs:seeAlso [ dcterms:type "image/tiff; application=geotiff" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/ndvi.tif> ] ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:calculate-indices> .

<urn:example:entity:calculate-indices:out:ndwi_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/calculate_indices#outputs/ndwi_file> ;
    rdfs:seeAlso [ dcterms:type "image/tiff; application=geotiff" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/ndwi.tif> ] ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:calculate-indices> .

<urn:example:entity:calculate-indices:out:savi_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/calculate_indices#outputs/savi_file> ;
    rdfs:seeAlso [ dcterms:type "image/tiff; application=geotiff" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/kindgrove-steps-calculate-indices-0001/results/savi.tif> ] ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:calculate-indices> .

<urn:example:entity:calculate-indices:in:band_files> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/calculate_indices#inputs/band_files> ;
    rdf:value [ a pp:geotiff ;
            pp:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/nir_4326.tif" ],
        [ a pp:geotiff ;
            pp:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/red_4326.tif" ],
        [ a pp:geotiff ;
            pp:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/green_4326.tif" ] .

<urn:example:image:ghcr.io/geolabs/kindgrove/calculate-indices:v0.0.2-rc2> a prov:SoftwareAgent ;
    pp:name "container image ghcr.io/geolabs/kindgrove/calculate-indices:v0.0.2-rc2" .

<urn:example:run:kindgrove-steps:calculate-indices> a prov:Activity,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/calculate-indices> ;
    prov:endedAtTime "2026-09-24T10:59:40+00:00"^^xsd:dateTime ;
    prov:qualifiedAssociation [ prov:agent <urn:example:engine:cwltool-3.1.20260108082145> ;
            prov:hadPlan <https://ospd.example.org/ogc-api/processes/calculate_indices> ] ;
    prov:startedAtTime "2026-09-24T10:59:32+00:00"^^xsd:dateTime ;
    prov:used <urn:example:entity:calculate-indices:in:band_files> ;
...
```json
{
  ...
  "type": "ProcessRun",
  "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/calculate-indices",
  "describedByProcess": "https://ospd.example.org/ogc-api/processes/calculate_indices",
  "usedInput": [
    {
      "id": "urn:example:entity:calculate-indices:in:band_files"
    }
...
<urn:example:run:kindgrove-steps:calculate-indices> a wfprov:ProcessRun,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/calculate-indices> ;
    wfprov:describedByProcess <https://ospd.example.org/ogc-api/processes/calculate_indices> ;
    wfprov:usedInput <urn:example:entity:calculate-indices:in:band_files> ;
...
```json
{
  "id": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/calculate-indices",
  "type": "ProcessType",
  "prefLabel": "Compute NDVI, NDWI and SAVI",
  ...
  "profile": "ospd.process-profiles.kindgrove-steps.calculate-indices",
  "processDescription": {
    "id": "calculate_indices",
    "version": "0.1.0"
  },
  "source": {
    "cwl": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#calculate_indices",
    "cwlClass": "CommandLineTool",
    "cwlId": "calculate_indices",
  ...
  "openeoEquivalence": {
    "level": "none",
    "rationale": "Composite, one tool computing three indices from the same three-band input at once. NDVI alone would be closeMatch `ogc.openeo.processes.cubes.ndvi`; NDWI alone closeMatch `ogc.openeo.processes.math.indices.normalized_difference` (as in `water-bodies.norm-diff` and `kindgrove.mangrove`); SAVI (soil-adjusted, not a plain normalized difference) has no openEO process in this register. Kept `none` for the tool as a whole since no single openEO process covers the composite.",
    "decomposition": [
      {
        "stage": "ndvi",
        "openeo": [
      ...
      },
      {
        ...
        "openeo": [],
        "level": "none",
        "note": "soil-adjusted vegetation index, no openEO process in this register"
      }
    ]
  }
}
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/calculate-indices> a skos:Concept ;
    skos:broader <https://geolabs.github.io/bblocks-process-profiles/def/phase/scientific-computation> ;
    skos:definition "Computes NDVI, NDWI and SAVI from Sentinel-2 red, green and NIR bands." ;
    skos:inScheme pp:process-type ;
    skos:prefLabel "Compute NDVI, NDWI and SAVI" ;
    pp:openeoEquivalence [ pp:decomposition ( [ pp:equivalenceLevel "closeMatch" ;
                        pp:openeo "ogc.openeo.processes.cubes.ndvi" ;
                        pp:stage "ndvi" ] [ pp:equivalenceLevel "closeMatch" ;
                        pp:openeo "ogc.openeo.processes.math.indices.normalized_difference" ;
                        pp:stage "ndwi" ] [ skos:note "soil-adjusted vegetation index, no openEO process in this register" ;
                        pp:equivalenceLevel "none" ;
                        pp:stage "savi" ] ) ;
            pp:equivalenceLevel "none" ;
            pp:rationale "Composite, one tool computing three indices from the same three-band input at once. NDVI alone would be closeMatch `ogc.openeo.processes.cubes.ndvi`; NDWI alone closeMatch `ogc.openeo.processes.math.indices.normalized_difference` (as in `water-bodies.norm-diff` and `kindgrove.mangrove`); SAVI (soil-adjusted, not a plain normalized difference) has no openEO process in this register. Kept `none` for the tool as a whole since no single openEO process covers the composite." ] ;
    pp:processDescription <https://geolabs.github.io/bblocks-process-profiles/def/process/calculate_indices> ;
    pp:profile "ospd.process-profiles.kindgrove-steps.calculate-indices" ;
    pp:provenanceClass wfprov:ProcessRun ;
    pp:source [ pp:cwl <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#calculate_indices> ;
            pp:cwlClass "CommandLineTool" ;
            pp:cwlId "calculate_indices" ;
...
description: Profile of the OGC API - Processes processDescription of `calculate_indices`
...
* YAML version: [schema.yaml](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/calculate-indices/schema.json)
* JSON version: [schema.json](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/calculate-indices/schema.yaml)
...
[context.jsonld](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/calculate-indices/context.jsonld)
...
* Path: `_sources/kindgrove-steps/calculate-indices`
