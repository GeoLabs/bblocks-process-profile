...
# Process profile: reproject_band (Schema)

`ospd.process-profiles.kindgrove-steps.reproject-band` *v0.1*
...
The CWL CommandLineTool is referenced, not copied: <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#reproject_band>.
...
```json
{
  ...
  "metadata": [
    ...
    },
    {
      ...
      "value": "Reproject a raster onto a regular grid covering a bounding box"
    }
  ],
  "inputs": {
    "band_file": {
...
```jsonld
{
  "@context": "https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/reproject-band/context.jsonld",
  "id": "reproject_band",
  "version": "0.1.0",
  "title": "reproject_band",
  "description": "Process converted from CWL",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/reproject_band> dcterms:description "Process converted from CWL" ;
    dcterms:subject "mangrove",
        "ospd",
        "reprojection" ;
    dcterms:title "reproject_band" ;
    pp:version "0.1.0" ;
    proc:inputs [ ns2:band_file [ dcterms:description "" ;
                    dcterms:title "band_file" ;
                    proc:maxOccurs 1 ;
                    proc:minOccurs 1 ;
    ...
    proc:metadata [ rdf:value "https://spdx.org/licenses/CC-BY-NC-SA-4.0" ;
        ...
        [ rdf:value "Reproject a raster onto a regular grid covering a bounding box" ;
    ...
    proc:outputTransmission "reference",
        "value" ;
    proc:outputs [ ns4:reprojected_file [ dcterms:description "" ;
                    dcterms:title "reprojected_file" ;
                    proc:schema [ proc:type "string" ;
                            ns1:contentMediaType "application/octet-stream" ] ] ] .
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#reproject_band",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/reproject_band> pp:version "0.1.0" .

[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/reproject_band> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#reproject_band" ;
...
```json
{
  "inputs": {
    "band_file": {
      "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/red.tif",
...
[] proc:inputs [ ns1:band_file [ ns1:href "https://ospd.example.org/ogc-api/jobs/upstream-step/results/red.tif" ;
                    proc:type "image/tiff; application=geotiff" ] ;
            ns1:east 9.535e+01 ;
            ns1:epsg 4326 ;
            ns1:north 1.61e+01 ;
            ns1:resolution 1e-04 ;
            ns1:south 1.59e+01 ;
            ns1:west 9.515e+01 ] ;
...
{
  "reprojected_file": {
    "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-reproject-band-0001/results/red_4326.tif",
    "type": "image/tiff; application=geotiff"
  }
}
...
[] pp:reprojected_file [ pp:href "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-reproject-band-0001/results/red_4326.tif" ] .
...
[
  {
    ...
    "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/reproject-band",
    "startedAtTime": "2026-09-24T10:59:12Z",
    "used": [
      "urn:example:entity:reproject-band:in:band_file",
      "urn:example:entity:reproject-band:in:west",
      "urn:example:entity:reproject-band:in:south",
      "urn:example:entity:reproject-band:in:east",
      "urn:example:entity:reproject-band:in:north",
      "urn:example:entity:reproject-band:in:epsg",
      "urn:example:entity:reproject-band:in:resolution"
    ],
    "wasAssociatedWith": [
      "urn:example:engine:cwltool-3.1.20260108082145",
      "urn:example:image:ghcr.io/geolabs/kindgrove/reproject-band:v0.0.2-rc2"
    ],
    "qualifiedAssociation": [
      {
        "agent": "urn:example:engine:cwltool-3.1.20260108082145",
        "hadPlan": "https://ospd.example.org/ogc-api/processes/reproject_band"
      }
    ],
    "endedAtTime": "2026-09-24T10:59:18Z"
  },
  {
    "id": "urn:example:entity:reproject-band:in:band_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/reproject_band#inputs/band_file",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/red.tif",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:reproject-band:in:west",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/reproject_band#inputs/west",
    "value": 95.15
  },
  {
    "id": "urn:example:entity:reproject-band:in:south",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/reproject_band#inputs/south",
    "value": 15.9
  },
  {
    "id": "urn:example:entity:reproject-band:in:east",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/reproject_band#inputs/east",
    "value": 95.35
  },
  {
    "id": "urn:example:entity:reproject-band:in:north",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/reproject_band#inputs/north",
    "value": 16.1
  },
  {
    "id": "urn:example:entity:reproject-band:in:epsg",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/reproject_band#inputs/epsg",
    "value": 4326
  },
  {
    "id": "urn:example:entity:reproject-band:in:resolution",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/reproject_band#inputs/resolution",
    "value": 0.0001
  },
  {
    "id": "urn:example:entity:reproject-band:out:reprojected_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/reproject_band#outputs/reprojected_file",
    "wasGeneratedBy": "urn:example:run:kindgrove-steps:reproject-band",
    "wasDerivedFrom": [
      "urn:example:entity:reproject-band:in:band_file"
    ],
    "links": [
  ...
  {
    "id": "urn:example:image:ghcr.io/geolabs/kindgrove/reproject-band:v0.0.2-rc2",
    "provType": "prov:SoftwareAgent",
    "name": "container image ghcr.io/geolabs/kindgrove/reproject-band:v0.0.2-rc2"
  }
]
...
<urn:example:entity:reproject-band:out:reprojected_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/reproject_band#outputs/reprojected_file> ;
    rdfs:seeAlso [ dcterms:type "image/tiff; application=geotiff" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/kindgrove-steps-reproject-band-0001/results/red_4326.tif> ] ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasDerivedFrom <urn:example:entity:reproject-band:in:band_file> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:reproject-band> .

<urn:example:entity:reproject-band:in:east> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/reproject_band#inputs/east> ;
    rdf:value 9.535e+01 .

<urn:example:entity:reproject-band:in:epsg> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/reproject_band#inputs/epsg> ;
    rdf:value 4326 .

<urn:example:entity:reproject-band:in:north> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/reproject_band#inputs/north> ;
    rdf:value 1.61e+01 .

<urn:example:entity:reproject-band:in:resolution> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/reproject_band#inputs/resolution> ;
    rdf:value 1e-04 .

<urn:example:entity:reproject-band:in:south> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/reproject_band#inputs/south> ;
    rdf:value 1.59e+01 .

<urn:example:entity:reproject-band:in:west> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/reproject_band#inputs/west> ;
    rdf:value 9.515e+01 .

<urn:example:image:ghcr.io/geolabs/kindgrove/reproject-band:v0.0.2-rc2> a prov:SoftwareAgent ;
    pp:name "container image ghcr.io/geolabs/kindgrove/reproject-band:v0.0.2-rc2" .

<urn:example:run:kindgrove-steps:reproject-band> a prov:Activity,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/reproject-band> ;
    prov:endedAtTime "2026-09-24T10:59:18+00:00"^^xsd:dateTime ;
    prov:qualifiedAssociation [ prov:agent <urn:example:engine:cwltool-3.1.20260108082145> ;
            prov:hadPlan <https://ospd.example.org/ogc-api/processes/reproject_band> ] ;
    prov:startedAtTime "2026-09-24T10:59:12+00:00"^^xsd:dateTime ;
    prov:used <urn:example:entity:reproject-band:in:band_file>,
        <urn:example:entity:reproject-band:in:east>,
        <urn:example:entity:reproject-band:in:epsg>,
        <urn:example:entity:reproject-band:in:north>,
        <urn:example:entity:reproject-band:in:resolution>,
...
<urn:example:entity:reproject-band:in:band_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/reproject_band#inputs/band_file> ;
    rdfs:seeAlso [ dcterms:type "image/tiff; application=geotiff" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/upstream-step/results/red.tif> ] .
...
```json
{
  ...
  "type": "ProcessRun",
  "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/reproject-band",
  "describedByProcess": "https://ospd.example.org/ogc-api/processes/reproject_band",
  "usedInput": [
    {
      "id": "urn:example:entity:reproject-band:in:band_file"
    },
...
<urn:example:run:kindgrove-steps:reproject-band> a wfprov:ProcessRun,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/reproject-band> ;
    wfprov:describedByProcess <https://ospd.example.org/ogc-api/processes/reproject_band> ;
    wfprov:usedInput <urn:example:entity:reproject-band:in:band_file>,
        <urn:example:entity:reproject-band:in:east>,
        <urn:example:entity:reproject-band:in:epsg>,
        <urn:example:entity:reproject-band:in:north>,
        <urn:example:entity:reproject-band:in:resolution>,
...
```json
{
  "id": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/reproject-band",
  "type": "ProcessType",
  "prefLabel": "Reproject a raster onto a regular grid",
  ...
  "profile": "ospd.process-profiles.kindgrove-steps.reproject-band",
  "processDescription": {
    "id": "reproject_band",
    "version": "0.1.0"
  },
  "source": {
    "cwl": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#reproject_band",
    "cwlClass": "CommandLineTool",
    "cwlId": "reproject_band",
  ...
  "openeoEquivalence": {
    "level": "closeMatch",
    "rationale": "resample_spatial with a target `resolution` and `projection` (epsg); no explicit resampling-method parameter in the CWL (implementation default), same partial match as `algae-bloom.reproject-image`."
  }
}
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/reproject-band> a skos:Concept ;
    ...
    skos:definition "Reprojects a raster onto a regular grid covering a bounding box." ;
    skos:inScheme pp:process-type ;
    skos:prefLabel "Reproject a raster onto a regular grid" ;
    pp:candidateCctDependency "eoap.cct.bbox" ;
    pp:openeoEquivalence [ pp:equivalenceLevel "closeMatch" ;
            pp:rationale "resample_spatial with a target `resolution` and `projection` (epsg); no explicit resampling-method parameter in the CWL (implementation default), same partial match as `algae-bloom.reproject-image`." ] ;
    pp:processDescription <https://geolabs.github.io/bblocks-process-profiles/def/process/reproject_band> ;
    pp:profile "ospd.process-profiles.kindgrove-steps.reproject-band" ;
    pp:provenanceClass wfprov:ProcessRun ;
    pp:source [ pp:cwl <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#reproject_band> ;
            pp:cwlClass "CommandLineTool" ;
            pp:cwlId "reproject_band" ;
...
description: Profile of the OGC API - Processes processDescription of `reproject_band`
...
* YAML version: [schema.yaml](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/reproject-band/schema.json)
* JSON version: [schema.json](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/reproject-band/schema.yaml)
...
[context.jsonld](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/reproject-band/context.jsonld)
...
* Path: `_sources/kindgrove-steps/reproject-band`
