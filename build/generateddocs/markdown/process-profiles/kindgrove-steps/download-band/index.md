...
# Process profile: download_band (Schema)

`ospd.process-profiles.kindgrove-steps.download-band` *v0.1*
...
The CWL CommandLineTool is referenced, not copied: <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#download_band>.
...
```json
{
  ...
  "metadata": [
    ...
    },
    {
      ...
      "value": "Download one Sentinel-2 band over a bounding box from a STAC Item"
    }
  ],
  "inputs": {
    "stac_item": {
...
```jsonld
{
  "@context": "https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/download-band/context.jsonld",
  "id": "download_band",
  "version": "0.1.0",
  "title": "download_band",
  "description": "Process converted from CWL",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/download_band> dcterms:description "Process converted from CWL" ;
    dcterms:subject "cog",
        "mangrove",
        "ospd",
        "sentinel-2" ;
    dcterms:title "download_band" ;
    pp:version "0.1.0" ;
    ...
    proc:metadata [ rdf:value "https://github.com/starling-foundries/KindGrove" ;
        ...
        [ rdf:value "Download one Sentinel-2 band over a bounding box from a STAC Item" ;
    ...
    proc:outputTransmission "reference",
        "value" ;
    proc:outputs [ ns4:band_file [ dcterms:description "" ;
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#download_band",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/download_band> pp:version "0.1.0" .

[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/download_band> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#download_band" ;
...
{
  "band_file": {
    "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-download-band-0001/results/red.tif",
...
[] pp:band_file [ pp:href "https://ospd.example.org/ogc-api/jobs/kindgrove-steps-download-band-0001/results/red.tif" ] .
...
[
  {
    ...
    "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/download-band",
    "startedAtTime": "2026-09-24T10:58:01Z",
    "used": [
      "urn:example:entity:download-band:in:stac_item",
      "urn:example:entity:download-band:in:band",
      "urn:example:entity:download-band:in:west",
      "urn:example:entity:download-band:in:south",
      "urn:example:entity:download-band:in:east",
      "urn:example:entity:download-band:in:north"
    ],
    "wasAssociatedWith": [
      "urn:example:engine:cwltool-3.1.20260108082145",
      "urn:example:image:ghcr.io/geolabs/kindgrove/download-band:v0.0.2-rc2"
    ],
    "qualifiedAssociation": [
      {
        "agent": "urn:example:engine:cwltool-3.1.20260108082145",
        "hadPlan": "https://ospd.example.org/ogc-api/processes/download_band"
      }
    ],
    "endedAtTime": "2026-09-24T10:58:16Z"
  },
  {
    "id": "urn:example:entity:download-band:in:stac_item",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/download_band#inputs/stac_item",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/upstream-step/results/scene_item.json",
        "rel": "item",
  ...
  {
    "id": "urn:example:entity:download-band:in:band",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/download_band#inputs/band",
    "value": "red"
  },
  {
    "id": "urn:example:entity:download-band:in:west",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/download_band#inputs/west",
    "value": 95.15
  },
  {
    "id": "urn:example:entity:download-band:in:south",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/download_band#inputs/south",
    "value": 15.9
  },
  {
    "id": "urn:example:entity:download-band:in:east",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/download_band#inputs/east",
    "value": 95.35
  },
  {
    "id": "urn:example:entity:download-band:in:north",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/download_band#inputs/north",
    "value": 16.1
  },
  {
    "id": "urn:example:entity:download-band:out:band_file",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/download_band#outputs/band_file",
    "wasGeneratedBy": "urn:example:run:kindgrove-steps:download-band",
    "wasDerivedFrom": [
      "urn:example:entity:download-band:in:stac_item"
    ],
    "links": [
  ...
  {
    "id": "urn:example:image:ghcr.io/geolabs/kindgrove/download-band:v0.0.2-rc2",
    "provType": "prov:SoftwareAgent",
    "name": "container image ghcr.io/geolabs/kindgrove/download-band:v0.0.2-rc2"
  }
]
...
<urn:example:entity:download-band:out:band_file> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/download_band#outputs/band_file> ;
    rdfs:seeAlso [ dcterms:type "image/tiff; application=geotiff" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/kindgrove-steps-download-band-0001/results/red.tif> ] ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasDerivedFrom <urn:example:entity:download-band:in:stac_item> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove-steps:download-band> .

<urn:example:entity:download-band:in:band> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/download_band#inputs/band> ;
    rdf:value "red" .

<urn:example:entity:download-band:in:east> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/download_band#inputs/east> ;
    rdf:value 9.535e+01 .

<urn:example:entity:download-band:in:north> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/download_band#inputs/north> ;
    rdf:value 1.61e+01 .

<urn:example:entity:download-band:in:south> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/download_band#inputs/south> ;
    rdf:value 1.59e+01 .

<urn:example:entity:download-band:in:west> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/download_band#inputs/west> ;
    rdf:value 9.515e+01 .

<urn:example:image:ghcr.io/geolabs/kindgrove/download-band:v0.0.2-rc2> a prov:SoftwareAgent ;
    pp:name "container image ghcr.io/geolabs/kindgrove/download-band:v0.0.2-rc2" .

<urn:example:run:kindgrove-steps:download-band> a prov:Activity,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/download-band> ;
    prov:endedAtTime "2026-09-24T10:58:16+00:00"^^xsd:dateTime ;
    prov:qualifiedAssociation [ prov:agent <urn:example:engine:cwltool-3.1.20260108082145> ;
            prov:hadPlan <https://ospd.example.org/ogc-api/processes/download_band> ] ;
    prov:startedAtTime "2026-09-24T10:58:01+00:00"^^xsd:dateTime ;
    prov:used <urn:example:entity:download-band:in:band>,
        <urn:example:entity:download-band:in:east>,
        <urn:example:entity:download-band:in:north>,
        <urn:example:entity:download-band:in:south>,
        <urn:example:entity:download-band:in:stac_item>,
...
<urn:example:entity:download-band:in:stac_item> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/download_band#inputs/stac_item> ;
...
```json
{
  ...
  "type": "ProcessRun",
  "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/download-band",
  "describedByProcess": "https://ospd.example.org/ogc-api/processes/download_band",
  "usedInput": [
    {
      "id": "urn:example:entity:download-band:in:stac_item"
    },
...
<urn:example:run:kindgrove-steps:download-band> a wfprov:ProcessRun,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/download-band> ;
    wfprov:describedByProcess <https://ospd.example.org/ogc-api/processes/download_band> ;
    wfprov:usedInput <urn:example:entity:download-band:in:band>,
        <urn:example:entity:download-band:in:east>,
        <urn:example:entity:download-band:in:north>,
        <urn:example:entity:download-band:in:south>,
        <urn:example:entity:download-band:in:stac_item>,
...
```json
{
  "id": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/download-band",
  "type": "ProcessType",
  "prefLabel": "Download one Sentinel-2 band over a bounding box",
  ...
  "profile": "ospd.process-profiles.kindgrove-steps.download-band",
  "processDescription": {
    "id": "download_band",
    "version": "0.1.0"
  },
  "source": {
    "cwl": "https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#download_band",
  ...
  "openeoEquivalence": {
    "level": "closeMatch",
    "rationale": "load_collection with a spatial_extent and a single band selected (filter_bands); the STAC item is a resolved File (the output of `select-scene`) rather than resolved in-process, same pattern as `algae-bloom.download-band-sentinel2-stac-item`."
  }
}
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove-steps/download-band> a skos:Concept ;
    ...
    skos:closeMatch <https://www.opengis.net/def/bblocks/ogc.openeo.processes.cubes.filter_bands>,
        <https://www.opengis.net/def/bblocks/ogc.openeo.processes.cubes.load_collection> ;
    skos:definition "Downloads one Sentinel-2 band over a bounding box from a STAC Item." ;
    skos:inScheme pp:process-type ;
    skos:prefLabel "Download one Sentinel-2 band over a bounding box" ;
    pp:candidateCctDependency "eoap.cct.bbox",
        "eoap.cct.stac" ;
    pp:openeoEquivalence [ pp:equivalenceLevel "closeMatch" ;
            pp:rationale "load_collection with a spatial_extent and a single band selected (filter_bands); the STAC item is a resolved File (the output of `select-scene`) rather than resolved in-process, same pattern as `algae-bloom.download-band-sentinel2-stac-item`." ] ;
    pp:processDescription <https://geolabs.github.io/bblocks-process-profiles/def/process/download_band> ;
    pp:profile "ospd.process-profiles.kindgrove-steps.download-band" ;
    pp:provenanceClass wfprov:ProcessRun ;
    pp:source [ pp:cwl <https://github.com/GeoLabs/KindGrove/releases/download/v0.0.2-rc2/mangrove-workflow-steps.cwl#download_band> ;
            pp:cwlClass "CommandLineTool" ;
            pp:cwlId "download_band" ;
...
description: Profile of the OGC API - Processes processDescription of `download_band`
...
* YAML version: [schema.yaml](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/download-band/schema.json)
* JSON version: [schema.json](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/download-band/schema.yaml)
...
[context.jsonld](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/download-band/context.jsonld)
...
* Path: `_sources/kindgrove-steps/download-band`
