...
```jsonld
{
  "@context": "https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/select-scene/context.jsonld",
  "id": "select_scene",
  "version": "0.1.0",
  "title": "select_scene",
  "description": "Process converted from CWL",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/select_scene> dcterms:description "Process converted from CWL" ;
    ...
    pp:version "0.1.0" ;
    proc:inputs [ ns1:cloud_cover_max [ dcterms:description "" ;
            ...
            ns1:collection [ dcterms:description "" ;
                    ...
                    proc:schema [ proc:default "\"sentinel-2-l2a\""^^rdf:JSON ;
                            proc:type "string" ] ] ;
            ns1:days_back [ dcterms:description "" ;
    ...
    proc:outputTransmission "reference",
        "value" ;
    proc:outputs [ ns4:stac_item [ dcterms:description "" ;
...
* YAML version: [schema.yaml](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/select-scene/schema.json)
* JSON version: [schema.json](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/select-scene/schema.yaml)
...
[context.jsonld](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/kindgrove-steps/select-scene/context.jsonld)
