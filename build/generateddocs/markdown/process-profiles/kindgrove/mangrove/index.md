...
# Process profile: mangrove_cli (Schema)

`ospd.process-profiles.kindgrove.mangrove` *v0.1*
...
The CWL CommandLineTool is referenced, not copied: <https://github.com/GeoLabs/bblocks-eoap-cct/blob/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#mangrove_cli>.
...
```jsonld
{
  "@context": "https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/kindgrove/mangrove/context.jsonld",
  "id": "mangrove_cli",
  "version": "0.0.1",
  "title": "mangrove_cli",
  "description": "Process converted from CWL",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/mangrove_cli> dcterms:description "Process converted from CWL" ;
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/GeoLabs/bblocks-eoap-cct/raw/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#mangrove_cli",
...
[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/mangrove_cli> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/GeoLabs/bblocks-eoap-cct/raw/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#mangrove_cli" ;
...
{
  "result": {
    "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-mangrove-0001/results/catalog.json",
...
[] pp:result [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/json> ;
            pp:href "https://ospd.example.org/ogc-api/jobs/kindgrove-mangrove-0001/results/catalog.json" ] .
...
[
  {
    ...
    "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/mangrove",
    "startedAtTime": "2026-09-23T08:01:12Z",
    "used": [
      "urn:example:entity:mangrove:in:west",
      "urn:example:entity:mangrove:in:south",
      "urn:example:entity:mangrove:in:east",
      "urn:example:entity:mangrove:in:north",
      "urn:example:entity:mangrove:in:cloud_cover_max",
      "urn:example:entity:mangrove:in:days_back",
      "urn:example:entity:mangrove:in:output_dir"
    ],
    "wasAssociatedWith": [
      "urn:example:engine:cwltool-3.1.20260108082145",
      "urn:example:image:ghcr.io/geolabs/kindgrove/mangrove-cwl:v0.0.1-rc7"
    ],
    "qualifiedAssociation": [
      {
        "agent": "urn:example:engine:cwltool-3.1.20260108082145",
        "hadPlan": "https://ospd.example.org/ogc-api/processes/mangrove_cli"
      }
    ],
    "endedAtTime": "2026-09-23T08:03:16Z"
  },
  {
    "id": "urn:example:entity:mangrove:in:west",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/west",
    "value": 95.15
  },
  {
    "id": "urn:example:entity:mangrove:in:south",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/south",
    "value": 15.9
  },
  {
    "id": "urn:example:entity:mangrove:in:east",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/east",
    "value": 95.35
  },
  {
    "id": "urn:example:entity:mangrove:in:north",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/north",
    "value": 16.1
  },
  {
    "id": "urn:example:entity:mangrove:in:cloud_cover_max",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/cloud_cover_max",
    "value": 20
  },
  {
    "id": "urn:example:entity:mangrove:in:days_back",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/days_back",
    "value": 90
  },
  {
    "id": "urn:example:entity:mangrove:in:output_dir",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/output_dir",
    "value": "outputs"
  },
  {
    "id": "urn:example:entity:mangrove:out:result",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/mangrove_cli#outputs/result",
    "wasGeneratedBy": "urn:example:run:kindgrove:mangrove",
    "links": [
      {
        "href": "https://ospd.example.org/ogc-api/jobs/kindgrove-mangrove-0001/results/catalog.json",
        "rel": "item",
  ...
  {
    "id": "urn:example:image:ghcr.io/geolabs/kindgrove/mangrove-cwl:v0.0.1-rc7",
    "provType": "prov:SoftwareAgent",
    "name": "container image ghcr.io/geolabs/kindgrove/mangrove-cwl:v0.0.1-rc7"
  }
]
...
<urn:example:entity:mangrove:out:result> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/mangrove_cli#outputs/result> ;
    rdfs:seeAlso [ dcterms:type "application/json" ;
            ns1:relation <http://www.iana.org/assignments/relation/item> ;
            oa:hasTarget <https://ospd.example.org/ogc-api/jobs/kindgrove-mangrove-0001/results/catalog.json> ] ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove:mangrove> .

<urn:example:entity:mangrove:in:cloud_cover_max> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/cloud_cover_max> ;
    rdf:value 20 .

<urn:example:entity:mangrove:in:days_back> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/days_back> ;
    rdf:value 90 .

<urn:example:entity:mangrove:in:east> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/east> ;
    rdf:value 9.535e+01 .

<urn:example:entity:mangrove:in:north> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/north> ;
    rdf:value 1.61e+01 .

<urn:example:entity:mangrove:in:output_dir> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/output_dir> ;
    rdf:value "outputs" .

<urn:example:entity:mangrove:in:south> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/south> ;
    rdf:value 1.59e+01 .

<urn:example:entity:mangrove:in:west> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/mangrove_cli#inputs/west> ;
    rdf:value 9.515e+01 .

<urn:example:image:ghcr.io/geolabs/kindgrove/mangrove-cwl:v0.0.1-rc7> a prov:SoftwareAgent ;
    pp:name "container image ghcr.io/geolabs/kindgrove/mangrove-cwl:v0.0.1-rc7" .

<urn:example:run:kindgrove:mangrove> a prov:Activity,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/mangrove> ;
    prov:endedAtTime "2026-09-23T08:03:16+00:00"^^xsd:dateTime ;
    prov:qualifiedAssociation [ prov:agent <urn:example:engine:cwltool-3.1.20260108082145> ;
            prov:hadPlan <https://ospd.example.org/ogc-api/processes/mangrove_cli> ] ;
    prov:startedAtTime "2026-09-23T08:01:12+00:00"^^xsd:dateTime ;
    prov:used <urn:example:entity:mangrove:in:cloud_cover_max>,
        <urn:example:entity:mangrove:in:days_back>,
        <urn:example:entity:mangrove:in:east>,
        <urn:example:entity:mangrove:in:north>,
        <urn:example:entity:mangrove:in:output_dir>,
...
```json
{
  ...
  "type": "ProcessRun",
  "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/mangrove",
  "describedByProcess": "https://ospd.example.org/ogc-api/processes/mangrove_cli",
  "usedInput": [
    {
      "id": "urn:example:entity:mangrove:in:west"
    },
...
<urn:example:run:kindgrove:mangrove> a wfprov:ProcessRun,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/mangrove> ;
    wfprov:describedByProcess <https://ospd.example.org/ogc-api/processes/mangrove_cli> ;
    wfprov:usedInput <urn:example:entity:mangrove:in:cloud_cover_max>,
        <urn:example:entity:mangrove:in:days_back>,
        <urn:example:entity:mangrove:in:east>,
        <urn:example:entity:mangrove:in:north>,
        <urn:example:entity:mangrove:in:output_dir>,
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/mangrove> a skos:Concept ;
    ...
    pp:source [ pp:cwl <https://github.com/GeoLabs/bblocks-eoap-cct/blob/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#mangrove_cli> ;
...
description: Profile of the OGC API - Processes processDescription of `mangrove_cli`
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/kindgrove/mangrove/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/kindgrove/mangrove/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/kindgrove/mangrove/context.jsonld)
...
* Path: `_sources/kindgrove/mangrove`
