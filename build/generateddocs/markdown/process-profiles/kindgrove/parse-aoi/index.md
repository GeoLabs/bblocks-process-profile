...
# Process profile: parse_aoi (Schema)

`ospd.process-profiles.kindgrove.parse-aoi` *v0.1*
...
The CWL CommandLineTool is referenced, not copied: <https://github.com/GeoLabs/bblocks-eoap-cct/blob/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi>.
...
```jsonld
{
  "@context": "https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/kindgrove/parse-aoi/context.jsonld",
  "id": "parse_aoi",
  "version": "0.0.1",
  "title": "parse_aoi",
  "description": "Process converted from CWL",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> dcterms:description "Process converted from CWL" ;
    dcterms:subject "OSPD",
        "biomass",
        "mangrove" ;
    dcterms:title "parse_aoi" ;
    pp:version "0.0.1" ;
    proc:inputs [ ns4:aoi [ dcterms:description "Area of interest defined as a bounding box" ;
    ...
    proc:metadata [ rdf:value "https://github.com/starling-foundries/KindGrove?tab=MIT-1-ov-file#readme" ;
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/GeoLabs/bblocks-eoap-cct/raw/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> pp:version "0.0.1" .

[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/GeoLabs/bblocks-eoap-cct/raw/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi" ;
...
[
  {
    ...
    "startedAtTime": "2026-09-23T08:01:11Z",
    "used": [
      "urn:example:entity:parse-aoi:in:aoi"
    ],
    "wasAssociatedWith": [
      "urn:example:engine:cwltool-3.1.20260108082145",
      "urn:example:image:alpine:3.22.2"
    ],
    "qualifiedAssociation": [
      {
        "agent": "urn:example:engine:cwltool-3.1.20260108082145",
        "hadPlan": "https://ospd.example.org/ogc-api/processes/parse_aoi"
      }
    ],
    "endedAtTime": "2026-09-23T08:01:12Z"
  },
  {
    "id": "urn:example:entity:parse-aoi:in:aoi",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/parse_aoi#inputs/aoi",
    "value": {
      "bbox": [
        95.15,
        15.9,
  ...
  {
    "id": "urn:example:entity:parse-aoi:out:east",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/east",
    "wasGeneratedBy": "urn:example:run:kindgrove:parse-aoi",
    "value": 95.35,
    "wasAttributedTo": "urn:example:engine:cwltool-3.1.20260108082145"
  },
  {
    "id": "urn:example:entity:parse-aoi:out:north",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/north",
    "wasGeneratedBy": "urn:example:run:kindgrove:parse-aoi",
    "value": 16.1,
    "wasAttributedTo": "urn:example:engine:cwltool-3.1.20260108082145"
  },
  {
    "id": "urn:example:entity:parse-aoi:out:output_dir",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/output_dir",
    "wasGeneratedBy": "urn:example:run:kindgrove:parse-aoi",
    "value": "outputs",
    "wasAttributedTo": "urn:example:engine:cwltool-3.1.20260108082145"
  },
  {
    "id": "urn:example:entity:parse-aoi:out:south",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/south",
    "wasGeneratedBy": "urn:example:run:kindgrove:parse-aoi",
    "value": 15.9,
    "wasAttributedTo": "urn:example:engine:cwltool-3.1.20260108082145"
  },
  {
    "id": "urn:example:entity:parse-aoi:out:west",
    "provType": "prov:Entity",
    "entityType": "https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/west",
    "wasGeneratedBy": "urn:example:run:kindgrove:parse-aoi",
    "value": 95.15,
    "wasAttributedTo": "urn:example:engine:cwltool-3.1.20260108082145"
  },
  ...
  {
    "id": "urn:example:image:alpine:3.22.2",
    "provType": "prov:SoftwareAgent",
    "name": "container image alpine:3.22.2"
  }
]
...
<urn:example:entity:parse-aoi:out:east> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/east> ;
    rdf:value 9.535e+01 ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove:parse-aoi> .

<urn:example:entity:parse-aoi:out:north> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/north> ;
    rdf:value 1.61e+01 ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove:parse-aoi> .

<urn:example:entity:parse-aoi:out:output_dir> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/output_dir> ;
    rdf:value "outputs" ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove:parse-aoi> .

<urn:example:entity:parse-aoi:out:south> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/south> ;
    rdf:value 1.59e+01 ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove:parse-aoi> .

<urn:example:entity:parse-aoi:out:west> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#outputs/west> ;
    rdf:value 9.515e+01 ;
    prov:wasAttributedTo <urn:example:engine:cwltool-3.1.20260108082145> ;
    prov:wasGeneratedBy <urn:example:run:kindgrove:parse-aoi> .

<urn:example:entity:parse-aoi:in:aoi> a prov:Entity,
        <https://ospd.example.org/ogc-api/processes/parse_aoi#inputs/aoi> ;
...
<urn:example:image:alpine:3.22.2> a prov:SoftwareAgent ;
    pp:name "container image alpine:3.22.2" .

<urn:example:run:kindgrove:parse-aoi> a prov:Activity,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/parse-aoi> ;
    prov:endedAtTime "2026-09-23T08:01:12+00:00"^^xsd:dateTime ;
    prov:qualifiedAssociation [ prov:agent <urn:example:engine:cwltool-3.1.20260108082145> ;
            prov:hadPlan <https://ospd.example.org/ogc-api/processes/parse_aoi> ] ;
    prov:startedAtTime "2026-09-23T08:01:11+00:00"^^xsd:dateTime ;
    prov:used <urn:example:entity:parse-aoi:in:aoi> ;
...
```json
{
  ...
  "type": "ProcessRun",
  "activityType": "https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/parse-aoi",
  "describedByProcess": "https://ospd.example.org/ogc-api/processes/parse_aoi",
  "usedInput": [
    {
      "id": "urn:example:entity:parse-aoi:in:aoi"
    }
  ...
  "wasPartOfWorkflowRun": "urn:example:run:kindgrove:mangrove-workflow"
}
...
<urn:example:run:kindgrove:parse-aoi> a wfprov:ProcessRun,
        <https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/parse-aoi> ;
    wfprov:describedByProcess <https://ospd.example.org/ogc-api/processes/parse_aoi> ;
    wfprov:usedInput <urn:example:entity:parse-aoi:in:aoi> ;
    wfprov:wasPartOfWorkflowRun <urn:example:run:kindgrove:mangrove-workflow> ;
    prov:startedAtTime "2026-09-23T08:01:11+00:00"^^xsd:dateTime ;
    prov:wasAssociatedWith <urn:example:engine:cwltool-3.1.20260108082145> .
...
```json
{
  ...
  "profile": "ospd.process-profiles.kindgrove.parse-aoi",
  "processDescription": {
    "id": "parse_aoi",
    "version": "0.0.1"
  },
  "source": {
    "cwl": "https://github.com/GeoLabs/bblocks-eoap-cct/blob/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi",
  ...
  "relatedMatch": [
    "https://www.opengis.net/def/bblocks/ogc.openeo.types.bounding-box"
  ],
  "openeoEquivalence": {
    "level": "none",
    "rationale": "Structural helper: unpacks an OGC BBox record into west/south/east/north floats and emits a constant `output_dir` (\"outputs\"). No openEO process does this, because openEO passes a bounding box object directly (`ogc.openeo.types.bounding-box`, relatedMatch at type level)."
  }
}
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/parse-aoi> a skos:Concept ;
    skos:broader <https://geolabs.github.io/bblocks-process-profiles/def/phase/filter-configuration> ;
    skos:definition "Unpacks an OGC bounding box (EOAP BBox custom type) into west, south, east and north coordinates." ;
    skos:inScheme pp:process-type ;
    skos:prefLabel "Parse area of interest" ;
    skos:relatedMatch <https://www.opengis.net/def/bblocks/ogc.openeo.types.bounding-box> ;
    pp:cctDependency "eoap.cct.bbox" ;
    pp:openeoEquivalence [ pp:equivalenceLevel "none" ;
            pp:rationale "Structural helper: unpacks an OGC BBox record into west/south/east/north floats and emits a constant `output_dir` (\"outputs\"). No openEO process does this, because openEO passes a bounding box object directly (`ogc.openeo.types.bounding-box`, relatedMatch at type level)." ] ;
    pp:processDescription <https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> ;
    pp:profile "ospd.process-profiles.kindgrove.parse-aoi" ;
    pp:provenanceClass wfprov:ProcessRun ;
    pp:source [ pp:cwl <https://github.com/GeoLabs/bblocks-eoap-cct/blob/c27c60d2755c01f69bd7f1bd0903b6388d375e58/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi> ;
...
description: Profile of the OGC API - Processes processDescription of `parse_aoi`
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/kindgrove/parse-aoi/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/kindgrove/parse-aoi/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/kindgrove/parse-aoi/context.jsonld)
