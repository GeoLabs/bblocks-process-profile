...
The CWL CommandLineTool is referenced, not copied: <https://github.com/GeoLabs/bblocks-eoap-cct/blob/291a741c3f2b61da7607f1dbb7a777134374227d/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi>.
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> dcterms:description "Process converted from CWL" ;
    ...
    pp:version "0.0.1" ;
    proc:inputs [ ns1:aoi [ dcterms:description "Area of interest defined as a bounding box" ;
                    ...
                    proc:schema [ proc:type "object" ;
                            ns3:properties [ ns3:bbox [ proc:type "array" ;
                                            ...
                                            ns3:oneOf [ dcterms:description "3D bbox" ;
                                                    ns3:maxItems 6 ;
                                                    ns3:minItems 6 ],
    ...
    proc:outputTransmission "reference",
        "value" ;
    proc:outputs [ ns4:east [ dcterms:description "" ;
                    dcterms:title "east" ;
                    proc:schema [ proc:type "number" ] ] ;
            ns4:north [ dcterms:description "" ;
                    dcterms:title "north" ;
                    proc:schema [ proc:type "number" ] ] ;
            ns4:output_dir [ dcterms:description "" ;
                    dcterms:title "output_dir" ;
                    proc:schema [ proc:type "string" ] ] ;
            ns4:south [ dcterms:description "" ;
                    dcterms:title "south" ;
                    proc:schema [ proc:type "number" ] ] ;
            ns4:west [ dcterms:description "" ;
                    dcterms:title "west" ;
                    proc:schema [ proc:type "number" ] ] ] .
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/GeoLabs/bblocks-eoap-cct/raw/291a741c3f2b61da7607f1dbb7a777134374227d/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi",
...
[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/parse_aoi> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/GeoLabs/bblocks-eoap-cct/raw/291a741c3f2b61da7607f1dbb7a777134374227d/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi" ;
...
```json
{
  ...
  "source": {
    "cwl": "https://github.com/GeoLabs/bblocks-eoap-cct/blob/291a741c3f2b61da7607f1dbb7a777134374227d/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/kindgrove/parse-aoi> a skos:Concept ;
    ...
    pp:source [ pp:cwl <https://github.com/GeoLabs/bblocks-eoap-cct/blob/291a741c3f2b61da7607f1dbb7a777134374227d/_sources/cwl-to-ogcprocess/examples/mangrove-workflow.cwl#parse_aoi> ;
