...
```jsonld
{
  "@context": "https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/algae-bloom/reproject-image/context.jsonld",
  "id": "reproject-image",
  "version": "1.0.0",
  "title": "Performs image reprojection.",
  "description": "Performs a reprojection over image bands and returns the resulting GeoTiff.",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/reproject-image> dcterms:description "Performs a reprojection over image bands and returns the resulting GeoTiff." ;
    ...
    pp:version "1.0.0" ;
    proc:inputs [ ns3:input_image [ dcterms:description "" ;
            ...
            ns3:output_dimensions [ dcterms:description "Output dimensions for (width, height) of the output image." ;
                    dcterms:title "output_dimensions" ;
                    proc:maxOccurs 1 ;
                    proc:minOccurs 0 ;
                    proc:schema [ proc:type "array" ;
                            ns1:items [ proc:type "integer" ] ] ] ;
            ns3:output_name [ dcterms:description "Name to apply for the output GeoTiff file." ;
                    dcterms:title "Output file name" ;
                    proc:maxOccurs 1 ;
                    proc:minOccurs 1 ;
                    proc:schema [ proc:type "string" ] ] ;
            ns3:output_resolution [ dcterms:description "Output resolution for (width, height) of the output image." ;
    ...
    proc:metadata [ rdf:value "https://spdx.org/licenses/CC-BY-NC-SA-4.0" ;
        ...
        [ rdf:value "Performs image reprojection." ;
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/reproject-image> dcterms:description "Performs a reprojection over image bands and returns the resulting GeoTiff." ;
    ...
    dcterms:title "Performs image reprojection." ;
    pp:version "1.0.0" ;
    proc:inputs [ ns2:input_image [ dcterms:description "" ;
                    dcterms:title "input_image" ;
                    proc:maxOccurs 1 ;
                    proc:minOccurs 1 ;
                    proc:schema [ proc:type "string" ;
                            ns1:contentMediaType "application/octet-stream" ] ] ;
            ns2:output_dimensions [ dcterms:description "Output dimensions for (width, height) of the output image." ;
                    dcterms:title "output_dimensions" ;
                    proc:maxOccurs 1 ;
                    proc:minOccurs 0 ;
                    proc:schema [ proc:type "array" ;
                            ns1:items [ proc:type "integer" ] ] ] ;
            ns2:output_name [ dcterms:description "Name to apply for the output GeoTiff file." ;
                    dcterms:title "Output file name" ;
                    proc:maxOccurs 1 ;
                    proc:minOccurs 1 ;
                    proc:schema [ proc:type "string" ] ] ;
            ns2:output_resolution [ dcterms:description "Output resolution for (width, height) of the output image." ;
                    dcterms:title "output_resolution" ;
                    proc:maxOccurs 1 ;
                    proc:minOccurs 0 ;
                    proc:schema [ proc:type "array" ;
                            ns1:items [ proc:type "integer" ] ] ] ] ;
    proc:jobControlOptions "async-execute" ;
    proc:metadata [ rdf:value "Performs a reprojection over image bands and returns the resulting GeoTiff." ;
            proc:role schema:description ],
        [ rdf:value "1.0.0" ;
            proc:role schema:softwareVersion ],
        [ rdf:value "Performs image reprojection." ;
...
* YAML version: [schema.yaml](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/algae-bloom/reproject-image/schema.json)
* JSON version: [schema.json](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/algae-bloom/reproject-image/schema.yaml)
...
[context.jsonld](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/algae-bloom/reproject-image/context.jsonld)
