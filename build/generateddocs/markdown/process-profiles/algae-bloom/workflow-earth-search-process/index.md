...
```jsonld
{
  "@context": "https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/algae-bloom/workflow-earth-search-process/context.jsonld",
  "id": "algae-usecase-workflow-earth-search-process",
  "version": "2.1.0",
  "title": "Processing on Sentinel-2 L2A bands to evaluate algae bloom.\n",
  "description": "Performs band calculation on Sentinel-2 L2A product bands\nto evaluate algae bloom for water quality assessment\nfrom a specific STAC Item reference from Earth-Search platform.\nReference bands are downloaded, processed, and returned as output\nwith raw data, color map and plot visualization.\n",
...
""" ;
    pp:version "2.1.0" ;
    proc:inputs [ ns3:product_url [ dcterms:description "The STAC Item should contain Assets with Sentinel-2 product bands." ;
...
""" ;
    ...
    proc:outputTransmission "reference",
        "value" ;
    proc:outputs [ ns4:chlorophyll_a [ dcterms:description "Raw data of chlorophyll-a calculation." ;
            ...
            ns4:cyanobacteria [ dcterms:description "Raw data of cyanobacteria calculation." ;
            ...
            ns4:cyanobacteria_plot [ dcterms:description "Plot representation of cyanobacteria." ;
                    ...
                    proc:schema [ proc:type "string" ;
                            ns1:contentEncoding "binary" ;
                            ns1:contentMediaType "image/png" ] ] ;
            ns4:turbidity [ dcterms:description "Raw data of turbidity calculation." ;
...
""" ;
    ...
    proc:outputTransmission "reference",
        "value" ;
    proc:outputs [ ns1:chlorophyll_a [ dcterms:description "Raw data of chlorophyll-a calculation." ;
                    dcterms:title "chlorophyll_a" ;
                    proc:schema [ proc:type "string" ;
            ...
            ns1:chlorophyll_a_plot [ dcterms:description "Plot representation of chlorophyll-a." ;
                    ...
                    proc:schema [ proc:type "string" ;
                            ns2:contentMediaType "application/octet-stream" ] ] ;
            ns1:cyanobacteria [ dcterms:description "Raw data of cyanobacteria calculation." ;
                    dcterms:title "cyanobacteria" ;
                    proc:schema [ proc:type "string" ;
                            ns2:contentMediaType "application/octet-stream" ] ] ;
            ...
            ns1:cyanobacteria_plot [ dcterms:description "Plot representation of cyanobacteria." ;
                    ...
                    proc:schema [ proc:type "string" ;
                            ns2:contentMediaType "application/octet-stream" ] ] ;
            ns1:turbidity [ dcterms:description "Raw data of turbidity calculation." ;
                    dcterms:title "turbidity" ;
                    proc:schema [ proc:type "string" ;
                            ns2:contentMediaType "application/octet-stream" ] ] ;
...
$defs:
  ...
  processTypeEntry:
    $ref: https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/process-type/schema.yaml
  w3cProvJsonLd:
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/algae-bloom/workflow-earth-search-process/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/algae-bloom/workflow-earth-search-process/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/GeoLabs/bblocks-process-profile/undefined/build/annotated/process-profiles/algae-bloom/workflow-earth-search-process/context.jsonld)
