...
The CWL CommandLineTool is referenced, not copied: <https://github.com/gfenoy/mastering-app-package/blob/40ecc096da56c6810758b87b01a87502f7c4507c/cwl-workflow/app-water-bodies-cloud-native.cwl#otsu>.
...
```jsonld
{
  "@context": "https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/water-bodies/otsu/context.jsonld",
  "id": "otsu",
  "version": "1.4.1",
  "title": "otsu",
  "description": "Process converted from CWL",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process/otsu> dcterms:description "Process converted from CWL" ;
    dcterms:title "otsu" ;
    pp:version "1.4.1" ;
    proc:inputs [ ns3:raster [ dcterms:description "" ;
    ...
    proc:outputTransmission "reference",
        "value" ;
    proc:outputs [ ns2:binary_mask_item [ dcterms:description "" ;
...
```json
{
  ...
  "executionUnit": {
    "href": "https://github.com/gfenoy/mastering-app-package/raw/40ecc096da56c6810758b87b01a87502f7c4507c/cwl-workflow/app-water-bodies-cloud-native.cwl#otsu",
...
[] pp:processDescription [ pp:process <https://geolabs.github.io/bblocks-process-profiles/def/process/otsu> ] ;
    proc:executionUnit [ a <https://geolabs.github.io/bblocks-process-profiles/def/application/cwl+yaml> ;
            pp:href "https://github.com/gfenoy/mastering-app-package/raw/40ecc096da56c6810758b87b01a87502f7c4507c/cwl-workflow/app-water-bodies-cloud-native.cwl#otsu" ;
...
[
  {
    ...
    "startedAtTime": "2026-09-23T18:03:45Z",
    "used": [
...
<urn:example:run:water-bodies:otsu> a prov:Activity,
    ...
    prov:startedAtTime "2026-09-23T18:03:45+00:00"^^xsd:dateTime ;
...
```json
{
  ...
  "source": {
    "cwl": "https://github.com/gfenoy/mastering-app-package/blob/40ecc096da56c6810758b87b01a87502f7c4507c/cwl-workflow/app-water-bodies-cloud-native.cwl#otsu",
...
<https://geolabs.github.io/bblocks-process-profiles/def/process-type/water-bodies/otsu> a skos:Concept ;
    ...
    pp:source [ pp:cwl <https://github.com/gfenoy/mastering-app-package/blob/40ecc096da56c6810758b87b01a87502f7c4507c/cwl-workflow/app-water-bodies-cloud-native.cwl#otsu> ;
...
* YAML version: [schema.yaml](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/water-bodies/otsu/schema.json)
* JSON version: [schema.json](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/water-bodies/otsu/schema.yaml)
...
[context.jsonld](https://geolabs.github.io/bblocks-process-profiles/build/annotated/process-profiles/water-bodies/otsu/context.jsonld)
